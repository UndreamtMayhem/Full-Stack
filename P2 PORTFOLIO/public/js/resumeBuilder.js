	...
	portofolio.display = function () {
		$.getJSON("/portfolio", function (data) {
			$.each(data.images, function (key, image) {
				var elem = HTMLportfolioRow + HTMLportfolioImageLeft.replace("%data%", image.imageleft) + HTMLportfolioImageRight.replace("%data%", image.imageright);
